...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    urdf_file = 'charging_robot.urdf'
    xacro_file = "charging_robot.urdf.xacro"
    #xacro_file = "box_bot.xacro"
    package_description = "charging_robot"
    use_urdf = False
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("charging_robot"), "rviz", "display_default.rviz"]
    )
